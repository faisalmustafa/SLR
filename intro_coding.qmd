...
---
## What is coding? {#sec-introduction}
...
After all the data is coded, it becomes easier for researchers to make sense of this data. Most importantly, the coded data can be reported systematically in a way that answers research questions. For example, looking at the diagram above, the themes can be systematically summarized, and the sample of report is presented below.

<div style = 'margin-left: 30px; margin-right: 30px; text-indent: 50px; text-align: justify;   text-justify: inter-word; font-family:"Times New Roman", Times, serif'>
...
flowchart LR
  ...
  Now we have learned theoritically what coding is, and the next section will show technical guideline on how to code using Qualitative Data Analysis (QDA) softwares. Researchers used to code the data manually or using generic software such as spreadsheet (Microsoft Excel, LibreOffice Writer, Apple Number, etc.); however, they rarely use this tool anymore today. Therefore, this book will not include a guideline for this conventional coding process, and <em> honestly I don't really know how to do it :). </em>