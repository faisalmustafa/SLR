...
Because the data included in the analysis should not include Article ID, we need to change the Article ID column into row name.
...
Now we should determine the optimal number of cluster.
...
Based on the result above, the optimal number of cluster is 3, so we can categorize them into high quality, medium quality, and low quality.