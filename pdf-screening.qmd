...
Now we can start the cluster analysis the data using  `stats` and `dendextend` package. `factoextra` is also common, in place of `dendextend`, but it did not work well when I tried it. It previously worked it the past.

```{r cache = FALSE, warning = 'hide', fig.width = 15, fig.height = 10}
